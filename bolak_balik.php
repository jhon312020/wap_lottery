<?php 
	...
	//////////////////////////////////////  C H E C K   I F   A N Y    R E S U L T    E X I S T ///////////////////////////////////
	if(isset($_REQUEST['key']) && $_REQUEST['key'] == "bolakForm") {
		...
		$sizeArray = getLengthArray($arrLotoNumber);
		$combArr = getAllCombos($arrLotoNumber);
		//echo $sizeArray;
		//echo '<pre>';
		//print_r($combArr); exit;
		//foreach($combArr as $com) {
		//$combination = str_replace(" ","",$com);
		//}
						...
						<div class="information-page-area">
							...
							<div  class="col-md-12 mrg-top-20">
								<div class="game-body">
									...
									<?php if(isset($_REQUEST['key']) && $_REQUEST['key'] == "bolakForm") {?>
														...
														<tbody>
															<?php 
																...
																<tr>
																	...
																	<td>
																		<input type="text" class="form-control input-width checkLoto" name="d1[]" id="d1_<?php echo $i?>" style="width:110px;" readonly value="<?php echo $combination;?>">
																	</td>
																	...
																	<td><input type="text" class="form-control checkBetAmount" name="show_bet_amount[]" id="show_betamount_<?php echo $i?>" style="width:100px;" readonly value="<?php echo $modBetPrice;?>"></td>
											...
											<div class="information-page-area" style="padding:25px 15px; min-height:0;">
												<div class="col-md-12 profileForm">
													...
													<form name="frm" id="member-form-update" method="POST" action="" role="form" enctype="multipart/form-data">
														<input type="hidden" name="key" value="bolakForm">
														<div class="form-group">
															<label for="email">Nomor : </label>
															<input type="text" name="lotto_no" id="lotto_no" maxlength="4">
														</div>
														<div class="form-group">
