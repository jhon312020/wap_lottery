...
$aboutus = mysql_fetch_array(mysql_query("SELECT * FROM `lottery_cms_pages` WHERE `cms_id` = 1"));
?>
<!DOCTYPE html>
<html lang="en">
  <head>
 ...
 <?php require_once("includes/header.php");?>
  ...
  <?php echo $aboutus['cms_page_title'];?> &nbsp;>&nbsp;<span class="text-atag"> <a href="index.php">Home</a></span>
 </div>
 
  
  <div class="clear"></div>
  <div class="col-md-12 abt-bg-area mrg-top-20">
  <span><img src="images/banner1.png" class="img-responsive image-space " width="300" height="300" alt="Chania"></span>
