...
$shio_lottery_type = array("-", "Monyet",  "Kambing", "Kuda", "Ular", "Naga", "Kelinci", "Harimau", "Kerbau", "Tikus", "Babi", "Anjing", "Ayam");
  ...
  <table border="1" width="100%" cellpadding="4" cellspacing="0" bordercolor="#999999" id='tabeldata' class='table table-bordered table-hover center'>
    ...
    ?>    
      <tr>
        ...
        <td class='history_detail_detail' align='center'>
          <?php 
            if (strtolower($arrTransferHistory['p_gametype']) == 'shio') {
              echo $shio_lottery_type[$arrTransferHistory['p_lottery_no']]; 
            } else {
              echo $arrTransferHistory['p_lottery_no']; 
            }
          ?>
        </td>
