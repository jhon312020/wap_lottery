...
<html lang="en">
	...
	<body>
		...
		<?php while($arrMarket = mysql_fetch_array($resMarket)) { ?>
			...
			<a href='number-output.php?market=<?php echo $arrMarket['market_name'];?>' class='btn btn-default form-control' style='margin-bottom: 5px;'><?php echo $arrMarket['market_name'];?><small> (<font color='#009900'>Online</font>)</small> </a>
		<?php } else { ?>
			<a href='number-output.php?market' class='btn btn-default form-control' style='margin-bottom: 5px;'><?php echo $arrMarket['market_name'];?><small> (<font color='#990000'>Offline</font>)</small> </a>
		<?php } } ?>
			</div>		<br /><br />	
		<hr/>			
